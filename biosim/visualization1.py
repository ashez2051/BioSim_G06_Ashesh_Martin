...
class Plotting:
    ...
    def init_plot(self, num_years):
        ...
        self._plot_map(self._map.map_str)
        self._plot_heatmap()
    ...
    def update_plot(self):
        ...
        weight_data = self._map.animal_weights
        ...
        fitness_data = self._map.animals_fitness
        ...
        age_data = self._map.animal_ages
        ...
        self._imax_herb.set_data(self._map.number_of_animals_per_species["Herbivore"])
        self._imax_carn.set_data(self._map.number_of_animals_per_species["Carnivore"])
    ...
    def _plot_heatmap(self):
        ...
        self.herb_pop_matrix = [
            [0 for _ in self._map.unique_cols] for _ in self._map.unique_rows
        ]
