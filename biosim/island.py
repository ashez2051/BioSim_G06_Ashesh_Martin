...
if __name__ == "__main__":
    ...
    ini_herbs = [{"loc": (1, 2), "pop": [
        {"species": "Herbivore", "age": 5, "weight": 20} for _ in range(50)]}]

    self.landscapes = {'W': Water, 'D': Desert, 'L': Lowland, 'H': Highland}
    self.landscapes_with_parameters = [Lowland]
