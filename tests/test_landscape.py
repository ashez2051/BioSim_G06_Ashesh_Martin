...
class TestLandscape:
    ...
    def test_no_birth_when_mother_loses_more_than_her_weight(self, landscape_data, mocker):
        ...
        :return:
        """
        mocker.patch("biosim.fauna.Fauna.weight_update_after_birth", return_value=False)
        lowland = landscape_data['L']
